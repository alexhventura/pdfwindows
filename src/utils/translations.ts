...
export const translations: Record<LanguageType, TranslationDict> = {
  pt: {
    ...
    textExportHint: "Nas definições avançadas, escolha TXT ou Word (.docx) compatível com Microsoft Word e LibreOffice. Gerado localmente no navegador.",
    ...
    toolUnavailable: "Ferramenta indisponível no momento.",
    routeErrorTitle: "Não foi possível abrir a ferramenta",
    routeErrorDescription: "Ocorreu um erro ao carregar esta página. Tente novamente ou atualize o navegador.",
    routeErrorRetry: "Tentar novamente",
  ...
  en: {
    ...
    textExportDocx: "Word (.docx)",
    textExportHint: "In advanced options, choose TXT or Word (.docx) for Microsoft Word and LibreOffice. Generated locally in your browser.",
    ...
    toolUnavailable: "This tool is unavailable right now.",
    routeErrorTitle: "Could not open this tool",
    routeErrorDescription: "Something went wrong while loading this page. Try again or refresh your browser.",
  ...
  es: {
    ...
    textExportDocx: "Word (.docx)",
    textExportHint: "En opciones avanzadas, elija TXT o Word (.docx) compatible con Microsoft Word y LibreOffice. Generado localmente en el navegador.",
    ...
    toolUnavailable: "Herramienta no disponible en este momento.",
    routeErrorTitle: "No se pudo abrir la herramienta",
    routeErrorDescription: "Ocurrió un error al cargar esta página. Inténtelo de nuevo o actualice el navegador.",
    routeErrorRetry: "Intentar de nuevo",
