...
export const translations: Record<LanguageType, TranslationDict> = {
  pt: {
    ...
    textExportHint: "Escolha TXT para arquivo simples ou Word (DOCX) para editar no Microsoft Word / LibreOffice. Tudo processado no seu navegador.",
  ...
  en: {
    ...
    textExportDocx: "Word (DOCX)",
    textExportHint: "Pick TXT for a simple file or Word (DOCX) to edit in Microsoft Word / LibreOffice. Everything runs in your browser.",
  ...
  es: {
    ...
    textExportDocx: "Word (DOCX)",
    textExportHint: "Elija TXT para un archivo simple o Word (DOCX) para editar en Microsoft Word / LibreOffice. Todo se procesa en su navegador.",
