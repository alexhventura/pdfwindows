...
export const translations: Record<LanguageType, TranslationDict> = {
  pt: {
    ...
    successMessage: "Conversão concluída com sucesso! Seus arquivos foram gerados.",
  ...
  es: {
    ...
    successMessage: "¡Conversión completada con éxito! Tus archivos se generaron correctamente.",
