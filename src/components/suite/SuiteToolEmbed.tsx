...
const SUITE_LAZY_TOOLS: Record<string, SuiteLazyTool> = {
  ...
  'cnpj-gen': lazy(() => import('./tools/CnpjSuiteTool')),
  'rg-gen': lazy(() => import('./tools/RgSuiteTool')),
  'phone-gen': lazy(() => import('./tools/PhoneSuiteTool')),
  'product-key-gen': lazy(() => import('./tools/ProductKeySuiteTool')),
  'pis-gen': lazy(() => import('./tools/PisSuiteTool')),
  'password-gen': lazy(() => import('./tools/PasswordSuiteTool')),
  ...
  'editable-pdf': lazy(() => import('./tools/EditablePdfSuiteTool').then((m) => ({ default: m.EditablePdfSuiteTool }))),
};
