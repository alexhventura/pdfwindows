...
const tools: Tool[] = [
  ...
  },
  {
    ...
    description: {
      pt: 'Links e textos em QR de alta qualidade, 100% local.',
      en: 'Links and text as high-quality QR codes, 100% local.',
      es: 'Enlaces y textos en QR de alta calidad, 100% local.',
    },
    icon: <QrCode size={24} />,
    color: 'bg-blue-500',
  },
  ...
  },
  {
    ...
    description: {
      pt: 'Relatórios e recibos profissionais com exportação PDF 100% local.',
      en: 'Professional reports and receipts with 100% local PDF export.',
      es: 'Informes y recibos profesionales con exportación PDF 100% local.',
    },
